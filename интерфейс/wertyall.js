    function good(){
    let specy = document.getElementById("wertygood");
    specy.style.animation = " geroin 0.5s backwards linear";
    ...
    function infogood(){
<<<<<<<< HEAD:front-end/js/wertyall.js
        let specy = document.getElementById("wertygood");
    specy.style.animation = " info 0.5s backwards linear";
    specy.style.marginLeft  = "90%";
    specy.style.display = "inline";
    specy.style.animationFillMode = "forwards";
    }
...
>>>>>>>> 7c9e81859684f9d0085019d26bad9212f7af5fcc:интерфейс/wertyall.js
